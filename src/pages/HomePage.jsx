    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center md:flex-row md:items-start">
        <div className="flex flex-row justify-center px-[4rem] py-[1rem] relative gap-[4rem] md:flex-col md:items-center md:gap-[1rem] ">
          ...
          <div className="hidden px-[4rem] py-[2rem] indent-[3rem] md:inline-block md:px-0">
          {showDetail === 1 && (
            <p>
        ...
        <div className="px-[4rem] py-[2rem] indent-[3rem] md:hidden">
          {showDetail === 1 && (
            <p>
              การแบ่งปันเป็นแนวคิดที่มีความสำคัญอย่างยิ่งในสังคม
              มันเป็นการกระจายทรัพยากร ความรู้ และโอกาสให้กับผู้อื่น
        ...
        <div className="flex flex-row justify-center px-[4rem] py-[1rem] gap-[4rem] md:flex-col md:items-center md:gap-[1rem] ">
          <div className="w-[15rem]  text-[.5rem]  cursor-pointer">
            ...
            <div className="border-[1px] border-gray-100 p-[1rem] h-[10rem] rounded-[0_0_50px_50px] text-[.5rem]  ]">
              <h3 className="text-[1.25rem]">MAKING FAMILY</h3>
              <p >
                คนที่กำลังสร้างครอบครัวมักจะเจริญทางส่วนตัวและรู้สึกมีความสำเร็จในชีวิตมากขึ้น
                เนื่องจากมีความรับผิดชอบที่ต้องดูแลกันและให้ความรักกันอย่างไม่มีเงื่อนไข
                นอกจากนี้ยังเป็นโอกาสที่จะเรียนรู้และเติบโตด้วยกันในทุกเรื่อง
                การสร้างครอบครัวยังเป็นหนทางสำคัญที่จะสร้างความสัมพันธ์และความผูกพันที่แข็งแรงซึ่งสามารถเป็นกำลังใจในชีวิตของแต่ละคนได้ในทุกสถานการณ์
              </p>
            </div>
          </div>
          <div className="w-[15rem] cursor-pointer">
            ...
            <div className="border-[1px] border-gray-100 p-[1rem] h-[10rem] rounded-[0_0_50px_50px] text-[.5rem] ">
              <h3 className="text-[1.25rem]">WORKING</h3>
              <p >
                ความทุ่มเทในงาน และความก้าวหน้าที่เขาได้ทำไปในสายอาชีพของเขาได้
                บุคคลแบบนี้มักมีความจุของความรู้และทักษะที่ต้องการสำหรับงานที่เขาทำ
                นอกจากนี้ยังมีความตั้งใจที่จะพัฒนาตัวเองให้ดียิ่งขึ้นอีกด้วย
              </p>
            </div>
          </div>
          <div className="w-[15rem]  cursor-pointer ">
            ...
            <div className="border-[1px] border-gray-100 p-[1rem] h-[10rem] rounded-[0_0_50px_50px] text-[.5rem]  ">
              <h3 className="text-[1.25rem]">GROWING UP</h3>
              <p >
                กระบวนการเรียนรู้และการเจริญเติบโตทั้งทางทักษะและการเชื่อมโยงทางสังคม
                นักศึกษามักมีโอกาสที่จะพบเจอความท้าทายในการเรียนการสอนและการเผชิญหน้ากับชีวิตจริง
                การเป็นนักศึกษายังเป็นช่วงเวลาที่สำคัญในการสร้างเป้าหมายและฝันให้เป็นจริง
                เขียนถึงความมุ่งมั่นในการเรียนรู้ การจัดการเวลา
                และการพัฒนาทักษะที่จะเป็นประโยชน์ในอนาคต
              </p>
            </div>
          </div>
        </div>
